...
export const translations = {
  en: {
    ...
    contactForm: {
      ...
      submit: 'Send message',
      sending: 'Sending…',
      rodo: 'Your data is used solely to reply to your message — never for marketing or a newsletter, and never shared with third parties.',
      consent: 'I agree to my data being used to reply to this message.',
      errors: {
        name: 'Please enter your name.',
        emailRequired: 'Please enter your email.',
        emailInvalid: 'Please enter a valid email address.',
        message: 'Please enter a message.',
        consent: 'Please confirm consent before sending.',
  ...
  pl: {
    ...
    contactForm: {
      ...
      sending: 'Wysyłanie…',
      rodo: 'Twoje dane wykorzystuję wyłącznie po to, by odpowiedzieć na Twoją wiadomość — nie służą do marketingu ani newslettera i nie są nikomu przekazywane.',
      consent: 'Zgadzam się na wykorzystanie moich danych w celu odpowiedzi na tę wiadomość.',
      errors: {
        ...
        consent: 'Potwierdź zgodę przed wysłaniem.',
