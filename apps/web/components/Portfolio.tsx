    ...
    <>
      <div className="shell">
        ...
        <div>
          ...
          {tab === 'contact' && <ContactView resume={resume} availabilityLabel={siteSettings.availabilityLabel} calendarUrl={siteSettings.calendarUrl} channels={siteSettings.channels} />}
        </div>
