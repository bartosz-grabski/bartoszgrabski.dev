    ...
    <>
      <div className="shell">
        ...
        <div>
          ...
          {tab === 'contact' && <ContactView resume={resume} showToast={showToast} availabilityLabel={siteSettings.availabilityLabel} calendarUrl={siteSettings.calendarUrl} channels={siteSettings.channels} />}
        </div>
